...
Test-ModuleManifest -Path ./SecuredArcana.psd1
...
Publish-Module `
    -Path "D:\OneDrive\PSCore\SecuredArcana" `
    -NuGetApiKey $securedArcanaApiKey `
    -WhatIf `
    -Verbose
